...
- $(3)$ **どちらも東経なので経度差は引き算**になる。

$$150°-120°=30°$$

  - 時差に直すと $30°\div 15°=2$ 時間。
  - 東にあるほど時刻が進むので、**東経 $150°$ の地点が2時間進んでいる**。
  - **例題Bとの対比**　例題Bは東経と西経をまたいだので足し算だった。ここは同じ側なので引き算。**本初子午線をまたぐかどうかで演算が決まる**という原則を、両方の型で確認しておく。
- 答え $(1)$ 単位・凡例・年次　$(2)$ 判定できない。医療費のデータが資料にないため　$(3)$ $2$ 時間。東経 $150°$ の地点が進んでいる
