...
// [slug, [試すWikipedia記事名の候補（順番に試す）]]
const UNIS = [
  ["hokkaido", ["北海道大学", "北海道大学病院"]],
  ["asahikawa-medical", ["旭川医科大学"]],
  ["hirosaki", ["弘前大学医学部", "弘前大学"]],
  ["tohoku", ["東北大学病院", "東北大学"]],
  ["akita", ["秋田大学医学部附属病院", "秋田大学"]],
  ["yamagata", ["山形大学医学部", "山形大学"]],
  ["fukushima-medical", ["福島県立医科大学"]],
  ["tsukuba", ["筑波大学附属病院", "筑波大学"]],
  ["gunma", ["群馬大学医学部附属病院", "群馬大学"]],
  ["chiba", ["千葉大学医学部附属病院", "千葉大学"]],
  ["tokyo", ["東京大学医学部附属病院", "東京大学"]],
  ["tokyo-science", ["東京科学大学", "東京医科歯科大学"]],
  ["niigata", ["新潟大学医歯学総合病院", "新潟大学"]],
...
async function fetchPageImage(title) {
  ...
  const res = await fetch(url, { headers: { "User-Agent": "medvance-img/1.0" } });
