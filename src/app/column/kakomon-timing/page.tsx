...
export const metadata = {
  title: "医学部受験の過去問はいつから解く？現役慶應医学部生が教える正しい始め方と復習法 | Medvance",
  description:
    "医学部受験の過去問はいつから始めるべき？高1・高2・高3・浪人別の最適な着手時期、国公立・私立医学部での使い分け、合格へ直結する正しい復習・再演習法まで現役慶應医学部生が徹底解説。",
  alternates: {
    canonical: "/column/kakomon-timing",
  },
  openGraph: {
    title: "医学部受験の過去問はいつから解く？現役慶應医学部生が教える正しい始め方と復習法",
    description:
      "医学部受験の過去問はいつから始めるべき？高1・高2・高3・浪人別の最適な着手時期、国公立・私立医学部での使い分け、合格へ直結する正しい復習・再演習法まで徹底解説。",
    type: "article",
