...
const faqItems = [
  ...
  },
  {
    ...
    a: "現役慶應医学部生による指導の場合、1コマ（80〜90分）1万〜2万円程度が相場です。月4回（週1回）で4〜8万円程度になります。コーチング（学習管理・進捗確認）が含まれるかどうかによっても費用は異なります。Medvanceでは週1回コース月8万円（授業＋コーチング込み）でご提供しています。",
  },
  {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3 mb-8">
            {[
              ...
              { label: "週2回コース", price: "月14万円〜", note: "月8回授業（80分）＋コーチング込み。受験本番に向けて強化したい方向け。" },
              { label: "週3回以上コース", price: "月20万円〜", note: "月12回以上。直前期・浪人生で短期集中したい方向け。" },
            ].map((item, i) => (
