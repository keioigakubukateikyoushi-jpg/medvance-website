...
const faqItems = [
  ...
  },
  {
    ...
    a: "現役慶應医学部生による指導の場合、1コマ（45分）7,500円（1回の授業90分 = 15,000円）が指導料の基準になります。Medvanceでは、授業料に加えて15分単位の学習計画管理などを行うコーチング（月額20,000円）を組み合わせたシンプルな構成となっています。具体的には、週1回コース（月4回授業＋コーチング）で月額8万円、週2回コース（月8回授業＋コーチング）で月額14万円から受講いただけます。",
  },
  {
...
export const metadata = {
  title: "慶應医学部の家庭教師｜現役慶應医学部生が1対1で指導 | Medvance",
  description:
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3 mb-8">
            {[
              ...
              { label: "週2回コース", price: "月14万円", note: "月8回授業（1回90分）＋コーチング込み。受験本番に向けて強化したい方向け。" },
