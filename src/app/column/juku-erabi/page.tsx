...
const faqItems = [
  ...
  },
  {
    ...
    a: "大手予備校の医学部コースは年間80〜150万円程度が一般的です。個別指導塾や家庭教師は1コマあたりの単価は高めですが、必要な科目・コマ数だけ取れるため総費用を抑えられる場合もあります。Medvanceでは月額8万円（月4回（8コマ））〜32万円（月20回（40コマ））で授業＋コーチングを提供しています（1コマ45分 7,500円換算）。",
  },
  {
...
export const metadata = {
  title: "医学部受験の塾・予備校の選び方｜失敗しない選択基準を解説",
  description:
