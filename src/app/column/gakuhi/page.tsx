  ...
  },
  {
    ...
    schools: [
      ...
      },
      {
        ...
        total: "約1,900万円",
        annual: "約310万円",
        note: "比較的新しい医学部だが国試合格率が高く、私立全体でも学費は低め。特待生制度あり。",
      },
      {
        name: "順天堂大学",
        total: "約2,100万円",
        annual: "約350万円",
        note: "私立上位校の中でも学費は低水準。教育環境・国試合格率ともに高評価。",
      },
      {
        name: "東京慈恵会医科大学",
        total: "約2,100万円",
  ...
  },
  {
    ...
    schools: [
      ...
      },
      {
        ...
        total: "約2,450万円",
        annual: "約410万円",
        note: "都内に複数の附属病院を持ち、実習環境が充実。",
      },
      {
        name: "日本大学（医学部）",
        total: "約2,500万円",
        annual: "約415万円",
        note: "私立大学の中では中規模。基礎〜標準問題が中心の入試傾向。",
      },
      {
        name: "近畿大学（医学部）",
        total: "約2,800万円",
        annual: "約465万円",
        note: "関西圏の有力私立医学部。近年難化傾向。",
      },
    ],
  },
  {
    ...
    schools: [
      {
        ...
        total: "約3,200万円",
        annual: "約530万円",
        note: "マークシート中心の出題で受験しやすい一方、学費は高め。",
      },
      {
        name: "聖マリアンナ医科大学",
        total: "約3,400万円",
      ...
      },
      {
        ...
        total: "約4,700万円",
        annual: "約780万円",
        note: "私立医学部の中では最も高額な部類。地域医療への貢献を重視した教育方針。",
      },
    ],
  },
];
