...
const faqItems = [
  ...
  },
  {
    ...
    a: "週1回コース（月4回授業＋コーチング）で月額8万円、週2回コース（月8回授業＋コーチング）で月額14万円、週3回〜コース（月12回以上＋コーチング）で月額20万円〜（割引あり）が指導料になります。1コマ（45分）7,500円（1回の授業90分 = 15,000円）＋コーチング月額20,000円のシンプルな構成で、別途管理費用は発生しません。",
  },
];
