...
const faqItems = [
  ...
  },
  {
    ...
    a: "週1回コース（月4回（8コマ）＋コーチング）で月額8万円、週2回コース（月8回（16コマ）＋コーチング）で月額14万円、週3回〜コース（月12回（24コマ）〜＋コーチング）で月額20万円〜（セット割引適用価格）が指導料になります。1コマ（45分）7,500円（1回の授業は90分（2コマ） = 15,000円）＋コーチング月額20,000円のシンプルな構成で、別途管理費用は発生しません。",
  },
];
