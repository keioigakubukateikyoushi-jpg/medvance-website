...
export const metadata = {
  title: "【医学部受験の塾・予備校おすすめ比較】2026合格率を高める選び方の基準 | Medvance",
  description:
    "医学部受験の塾・予備校を徹底比較。大手予備校・医学部専門予備校・個別指導・映像授業の違いから年間費用相場、失敗しない選び方の基準まで解説。現役慶應医学部生による完全1対1指導のMedvanceが選ばれる理由。",
  keywords: [
    "医学部 塾 おすすめ",
    "医学部 予備校 おすすめ",
    "医学部受験 塾 比較",
...
export default function IgakubuJukuOsusumeePage() {
  return (
    <div className="min-h-screen bg-white">
      <ColumnArticleSchemas slug="igakubu-juku-osusume" articleOnly />
