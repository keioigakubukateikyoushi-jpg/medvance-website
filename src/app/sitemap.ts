...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/download`, lastModified: D("2026-03-21"), changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE}/success-stories`, lastModified: D("2026-03-21"), changeFrequency: "monthly", priority: 0.5 },
    // 対象者別
