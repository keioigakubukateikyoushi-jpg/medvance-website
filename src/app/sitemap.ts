...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/tutors`, lastModified: D("2026-04-22"), changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE}/recruit`, lastModified: D("2026-04-22"), changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE}/privacy`, lastModified: D("2026-04-23"), changeFrequency: "yearly", priority: 0.3 },
    { url: `${BASE}/terms`, lastModified: D("2026-04-23"), changeFrequency: "yearly", priority: 0.3 },
    { url: `${BASE}/tokushoho`, lastModified: D("2026-04-23"), changeFrequency: "yearly", priority: 0.3 },
