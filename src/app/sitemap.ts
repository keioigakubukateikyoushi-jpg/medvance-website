...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/for/nangandai`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE}/for/suisen-ao`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    // サービス別
