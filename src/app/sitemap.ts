...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/about/founder`, lastModified: gitMtime("src/app/about/founder/page.tsx", "2026-04-20"), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/for-ai`, lastModified: gitMtime("src/app/for-ai/page.tsx", "2026-07-12"), changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${BASE}/pricing`, lastModified: pageMtime("pricing"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE}/calendar`, lastModified: pageMtime("calendar"), changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE}/science`, lastModified: pageMtime("science"), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/success-stories`, lastModified: pageMtime("success-stories"), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/download`, lastModified: pageMtime("download"), changeFrequency: "monthly", priority: 0.5 },
