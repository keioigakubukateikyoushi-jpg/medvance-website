      ...
      <section className="py-24 px-4 bg-slate-50 border-t border-b border-slate-200">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 mb-12">
            {[
              {
                title: "週1回コース (80分授業×月4回 + 徹底コーチング)",
                price: "月額 80,000円〜",
                target: "他予備校と併用したい方、苦手な1科目を徹底的に慶應医学部生に対策してほしい方"
              },
              {
                title: "週2回コース (80分授業×月8回 + 徹底コーチング)",
                price: "月額 140,000円〜",
                target: "英語・数学の2枚看板を強化したい方、自習計画と記述答案の添削を完全に任せたい方"
              },
              {
                title: "週3回以上・直前期集中コース (80分授業×月12回〜 + 徹底コーチング)",
                price: "月額 200,000円〜",
                target: "浪人生・再受験生の方で全科目の指導管理を依頼したい方、または直前期の模擬面接・小論文対策を短期間で仕上げたい方"
              }
            ].map((course, i) => (
              <div 
                key={i} 
