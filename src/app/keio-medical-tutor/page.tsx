...
export const metadata = {
  title: "【慶應医学部受験・内部推薦】系列校別評定アップ特化の家庭教師 | Medvance",
  description:
    "【慶應医学部推薦・一般受験】現役慶應医学部生による完全1対1個別指導。一般選抜はもちろん、系列校（塾高・女子高・志木・SFC等）の学年トップクラス評定（GPA）管理・学内試験分析に特化した対策で医学部推薦枠を勝ち取ります。AI管理＆データ共有対応。",
  keywords: [
    "慶應医学部 家庭教師",
    "慶應医学部 内部推薦",
    "塾高 医学部 推薦",
...
const competitorCounterPoints = [
  {
    ...
    body: "一般的な仲介サービスや家庭教師センターでは、講師をアサインした後は学生講師の「個人の経験や我流の指導」に完全にブラックボックス化されます。Medvanceでは、慶應医学部の受験を勝ち抜いた一般受験生、内部進学生が監修した、どのレベルからでも慶應医学部に合格するための体系化された再現性ある指導メソッドを全講師が共有・実践しています。"
  },
  {
