...
const strategies = [
  ...
  },
  {
    ...
    body: "杏林大学では特定科目で突出したスコアよりも、英語・数学・理科2科目すべてでバランスよく得点することが合格への近道です。合計点で合否が決まる以上、1科目の苦手が命取りになります。苦手科目を放置せず、定期的に模試を利用して弱点を発見・克服する習慣を早期につけましょう。週単位で全科目のバランスを確認しながら学習計画を調整する意識が重要です。",
  },
  {
    step: "03",
...
const faqs = [
  ...
  {
    q: "募集人員と倍率を教えてください。",
    a: "一般選抜の募集人員は約79名で、競争倍率は年度によって6〜9倍程度です。私立医学部の中では比較的受験しやすい規模感ですが、しっかりとした対策が不可欠です。",
  },
  {
      ...
      <div style={{ backgroundColor: "#0c1a33" }} className="py-24 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["基礎力重視の出題", "三鷹・附属病院3院", "約107名募集", "倍率6〜9倍"].map((tag) => (
              <span
                key={tag}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-white" style={{ border: "1px solid #e5e1d8" }}>
            <p className="text-sm leading-relaxed mb-4" style={{ color: "#3d3d3d" }}>
              杏林大学医学部は東京都三鷹市に位置し、三鷹・杉並・高井戸に附属病院を持つ総合的な医療教育機関です。一般選抜は英語・数学・理科2科目（物理または化学から2科目）の筆記試験と小論文・面接が課されます。
            </p>
