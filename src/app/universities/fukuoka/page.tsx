...
const subjects = [
  ...
  },
  {
    ...
    tips: [
      ...
      "記述式問題は解答過程を論理的に書く練習が必要。答えだけでなく途中式の丁寧さが評価される。",
...
const strategies = [
  {
    ...
    body: "福岡大学医学部は「全科目バランス型」の入試です。得意科目で稼ぐ作戦より、苦手科目をなくして全科目で安定した得点を取ることが合格への最短ルートです。定期的に模試で各科目の得点を確認し、最も遅れている科目の補強を優先する学習計画を維持しましょう。競争倍率が高い分、1科目の大きな失点が命取りになります。",
  },
  {
    step: "02",
...
const mistakes = [
  {
    ...
    body: "福岡大学医学部は全科目バランス型の入試です。「英語は得意だから数学を頑張れば合格できる」という考えでは、競争率8〜13倍の中で合格水準に達しません。どの科目も全受験生が一定レベルを満たしてきます。苦手科目での大幅な失点が不合格の直接原因になるため、全科目を均等に仕上げる学習計画を維持することが重要です。",
  },
  {
...
const faqs = [
  {
    ...
    a: "私立医学部の中では標準的な難易度です。全科目で基礎〜標準問題が中心ですが、競争倍率が8〜13倍と高いため、各科目で着実に得点することが求められます。全科目バランスよく仕上げることが合格への最重要条件です。",
  },
  {
