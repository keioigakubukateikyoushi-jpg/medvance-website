...
const subjects = [
  ...
  },
  {
    name: "面接・小論文",
    level: "★★★☆☆",
    body: "医師を志す動機と医療への姿勢を問う面接が実施されます。北里大学の建学精神と感染症研究への理解を示すと好印象です。",
    detail: "個人面接形式で、志望動機・医師像・医療倫理に関する質問が中心です。北里柴三郎を創立者とする歴史ある大学であり、研究や感染症医学への関心を示すと評価されます。小論文は医療・社会問題に関するテーマで600〜800字程度です。論理的な構成と自分の意見を明確に述べる力が問われます。",
  },
  {
    name: "総合戦略",
    level: "★★★☆☆",
...
const faqs = [
  ...
  {
    q: "募集人員と倍率を教えてください。",
    a: "一般選抜の募集人員は約65名で、競争倍率は年度によって8〜12倍程度です。物理対策が充実しているかどうかが合否を大きく左右します。",
  },
  {
      ...
      <div style={{ backgroundColor: "#0c1a33" }} className="py-24 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["物理がやや難", "感染症研究が有名", "約65名募集", "倍率8〜12倍"].map((tag) => (
              <span
                key={tag}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-white" style={{ border: "1px solid #e5e1d8" }}>
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ color: "#3d3d3d" }}>
              入試は英語・数学・理科2科目（物理または化学）の1次試験と、面接・小論文の2次試験が課されます。特に物理はやや難易度が高く、応用問題まで対応できる実力が求められます。全科目でバランスよく得点しながら、理科での失点を最小限に抑えることが合格への近道です。
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { label: "募集人員", value: "約65名" },
