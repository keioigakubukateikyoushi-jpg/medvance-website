        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-16">
            {[
              ...
              { name: "日本大学医学部", desc: "全科目標準レベル。基礎〜標準問題を確実に取る完成度が合否を決める。", href: "/universities/nihon" },
              { name: "東邦大学医学部", desc: "英語の長文量が多く読解スピードが鍵。計算ミスが合否を分ける。", href: "/universities/toho" },
              { name: "杏林大学医学部", desc: "比較的取り組みやすい問題構成。基礎の完成が最重要。", href: "/universities/kyorin" },
              { name: "帝京大学医学部", desc: "マークシート中心。スピードと正確性の両立が求められる。", href: "/universities/teikyo" },
              { name: "東海大学医学部", desc: "英語長文と数学計算力が重要。全科目バランスよく仕上げることが鍵。", href: "/universities/tokai" },
              { name: "北里大学医学部", desc: "理科の難易度がやや高め。基礎固め後に理科を重点強化する戦略が有効。", href: "/universities/kitasato" },
              { name: "聖マリアンナ医科大学", desc: "建学精神に基づく面接が特徴。ボランティア経験や医療への動機が重視される。", href: "/universities/marianna" },
              { name: "東京女子医科大学", desc: "女子大唯一の専門校。女性医師としての覚悟と将来像が問われる。", href: "/universities/joshi-ika" },
              { name: "国際医療福祉大学医学部", desc: "英語重視のグローバル教育。英語力が特に重要で十分な対策が必須。", href: "/universities/iuhw" },
              { name: "獨協医科大学", desc: "英語・数学の基礎固めが合否を分ける。小論文も課される。", href: "/universities/dokkyo" },
              { name: "埼玉医科大学", desc: "標準レベル中心。地域医療への関心が面接で評価される。", href: "/universities/saitama-ika" },
              { name: "関西医科大学", desc: "関西圏の難関私立医学部。英語の読解力が特に重要。", href: "/universities/kansai-ika" },
              { name: "近畿大学医学部", desc: "近年難化傾向あり。英語長文読解力が鍵。", href: "/universities/kindai" },
              { name: "大阪医科薬科大学", desc: "関西圏の名門。全体的に難易度が高く、英数理とも高い実力が必要。", href: "/universities/osaka-ika" },
              { name: "兵庫医科大学", desc: "標準レベル。全科目バランスよく仕上げることが合格への近道。", href: "/universities/hyogo" },
              { name: "藤田医科大学", desc: "中部圏最大規模。比較的取り組みやすく基礎〜標準力の完成が条件。", href: "/universities/fujita" },
              { name: "愛知医科大学", desc: "標準問題中心。基礎力の完成度が合否を直接左右する。", href: "/universities/aichi-ika" },
              { name: "金沢医科大学", desc: "北陸唯一の私立医学部。標準レベルで理科のバランスよい対策が重要。", href: "/universities/kanazawa-ika" },
              { name: "久留米大学医学部", desc: "九州圏。英語の読解力と理科の基礎が合否を分ける。", href: "/universities/kurume" },
              { name: "福岡大学医学部", desc: "九州圏。全科目バランス型で標準問題を落とさない完成度が求められる。", href: "/universities/fukuoka" },
              { name: "川崎医科大学", desc: "合格難易度は比較的低め。ただし学費が高水準のため計画的な受験戦略が必要。", href: "/universities/kawasaki-ika" },
              { name: "岩手医科大学", desc: "東北地方の地域密着型医学部。地域医療への志望動機が重視される。", href: "/universities/iwate" },
              { name: "東北医科薬科大学", desc: "2016年新設。東北の医療人材育成を目的。英数理の基礎力が重要。", href: "/universities/tohoku-ika" },
            ].map((item) => (
