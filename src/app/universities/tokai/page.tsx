...
const subjects = [
  ...
  },
  {
    name: "数学",
    level: "★★★☆☆",
    body: "標準〜やや難しい問題が出題されます。微積分・確率・ベクトルが頻出で、論理的な解法展開と正確な計算力が評価されます。",
    detail: "大問4〜5題で構成され、微積分・確率・数列・ベクトル・複素数平面が頻出です。計算量が多い問題もあるため、正確かつ素早い計算力が必要です。青チャートから1対1対応の演習レベルまで仕上げ、解法の論理展開を丁寧に記述できるよう練習しましょう。",
  },
  {
    name: "物理",
    level: "★★★☆☆",
...
const strategies = [
  ...
  },
  {
    ...
    body: "東海大学の数学・理科は計算量が多く、正確で素早い計算力が求められます。また、記述式の問題では論理的な解法展開が評価されます。普段から解答の論理展開を丁寧に書く習慣をつけ、計算ミスを防ぐための検算ルーティンを確立しましょう。",
  },
  {
    step: "04",
...
const faqs = [
  ...
  {
    q: "募集人員と倍率を教えてください。",
    a: "一般選抜の募集人員は約100名で、競争倍率は年度によって8〜12倍程度です。私立医学部の中では標準的な倍率です。",
  },
  {
      ...
      <div style={{ backgroundColor: "#0c1a33" }} className="py-24 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["全科目バランス型", "地域医療重視", "約100名募集", "倍率8〜12倍"].map((tag) => (
              <span
                key={tag}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-white" style={{ border: "1px solid #e5e1d8" }}>
            <p className="text-sm leading-relaxed mb-4" style={{ color: "#3d3d3d" }}>
              東海大学医学部は神奈川県伊勢原市に位置し、地域医療への貢献を重視した医師教育を行っています。一般選抜は英語・数学・理科2科目（物理または化学から2科目）の筆記試験と小論文・面接が課されます。
            </p>
