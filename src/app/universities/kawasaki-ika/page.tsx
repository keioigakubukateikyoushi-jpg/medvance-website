    ...
    <div className="min-h-screen bg-white">
      <UniversityHero slug="kawasaki-ika">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4" style={{ fontFamily: "var(--font-noto-serif)" }}>川崎医科大学<br />入試対策ガイド</h1>
      ...
      <div className="py-14 px-4" style={{ backgroundColor: "#f7f5f0" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl font-bold mb-4" style={{ color: "#0c1a33", fontFamily: "var(--font-noto-serif)" }}>川崎医科大学の特徴</h2>
      ...
      <div className="py-16 px-4" style={{ backgroundColor: "#0c1a33" }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-3" style={{ fontFamily: "var(--font-noto-serif)" }}>川崎医科大学対策の相談はこちら</h2>
