...
const subjects = [
  ...
  },
  {
    name: "面接",
    level: "★★★☆☆",
    body: "帝京大学は1次試験通過後に面接（2次試験）があります。受験者数が多い分、面接での印象が合否を左右する場面もあります。",
    detail: "志望動機・医師としての考え・医療問題への意見が問われます。帝京大学は附属病院での臨床実習が充実しており、実践的な医師教育を重視しています。その点に共感した具体的な志望動機を準備しましょう。受験者数が非常に多い大学なので、集団面接や個人面接の形式を事前に確認して準備することが重要です。",
  },
  {
    name: "総合対策",
    level: "★★★☆☆",
...
const strategies = [
  ...
  },
  {
    ...
    body: "帝京大学は受験者数が私立医学部最多クラスで、倍率は15〜25倍に達することもあります。しかし高倍率の多くは準備不足の受験生です。典型問題で確実に得点できる状態を作れば、十分に合格圏内に入れます。倍率の数字に過度に緊張せず、自分の学力を着実に積み上げることに集中しましょう。",
  },
];
...
const mistakes = [
  ...
  },
  {
    ...
    body: "帝京大学の倍率15〜25倍という数字は非常に高く見えますが、多くは対策が不十分な受験生です。典型問題を確実に得点できる状態を作れば、十分に合格圏内に入れます。倍率の数字に過度に萎縮せず、自分の学力を着実に積み上げることに集中してください。",
  },
];
...
const whyMedvance = [
  ...
  },
  {
    ...
    body: "倍率15〜25倍の帝京大学を突破するには、典型問題で確実に得点できる状態を早期に作ることが重要です。現役慶應医学部生が学習の優先順位と弱点補強のタイミングを個別にサポートします。",
  },
  {
...
const faqs = [
  ...
  {
    q: "募集人員と倍率を教えてください。",
    a: "一般選抜の募集人員は約76名です。競争倍率は年度によって15〜25倍に達することがあり、私立医学部の中でも最多レベルの受験者数を誇ります。",
  },
  {
    q: "帝京大学医学部に面接はありますか？",
    a: "2次試験として面接があります。1次試験（筆記）を通過した後に面接が実施されます。志望動機・医師を目指す理由・医療問題への意見などが問われます。",
  },
  {
    q: "帝京大学医学部はマーク式のみですか？",
    a: "1次試験はマークシート式が中心です。記述式と異なり途中の論証は不要で、最終的な答えの正確さが評価されます。2次試験は面接形式です。",
  },
  {
      ...
      <div style={{ backgroundColor: "#0c1a33" }} className="py-24 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["マークシート中心", "受験者数最多レベル", "約107名募集", "倍率15〜25倍"].map((tag) => (
              <span
                key={tag}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-white" style={{ border: "1px solid #e5e1d8" }}>
            <p className="text-sm leading-relaxed mb-4" style={{ color: "#3d3d3d" }}>
              帝京大学医学部は東京都板橋区に位置し、私立医学部の中で受験者数が最多レベルの大学です。一般選抜の最大の特徴はマークシート方式が中心であること。英語（必須）＋数学・物理・化学・生物・国語から2科目選択の筆記試験と2次面接が課されます。
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { label: "募集人員", value: "約76名" },
                { label: "競争倍率", value: "15〜25倍" },
