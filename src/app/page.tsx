          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            {(() => {
              ...
              const leftPainPoints = [
                ...
                {
                  title: "慶應など附属校の定期テストで",
                  subtitle: "高い評定を維持して医学部へ内部進学したい",
                  mobileText: "慶應などの附属校で高い評定を維持して医学部の推薦枠を勝ち取りたい",
                  icon: "target",
                  num: "04",
                  solution: "慶應高・志木高・女子高・SFCなど各附属校に特化した「定期試験の傾向分析」と「評定平均（GPA）対策」をマンツーマンで指導。競争の激しい医学部推薦枠の獲得を圧倒的に有利にします。"
                },
                {
                  title: "面接や小論文の対策も",
              ...
              const rightPainPoints = [
                {
                  ...
                  icon: "academic",
                  num: "06",
                  solution: "最難関を自力で突破した「現役慶應医学部生」のみが指導。彼らが実際に使った参考書、解き方のコツ、合格するための思考プロセスをダイレクトに伝授します。"
                },
                {
                  title: "お子様の弱点や得意に",
                ...
                {
                  title: "附属校での進級・推薦対策と",
                  subtitle: "他大医学部の一般受験対策を両立したい",
                  mobileText: "附属校での進級・内部推薦対策と、他大学の医学部受験対策を賢く両立させたい",
                  icon: "clipboard",
                  num: "10",
                  solution: "学校の評定を維持するための定期テスト対策と、他大一般入試対策の学習比率を個別に最適化。どちらも妥協することなく、最短ルートで医学部合格へ導く両立計画を作成します。"
                },
              ];
