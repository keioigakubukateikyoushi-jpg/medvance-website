...
export const metadata = {
  title: {
    absolute: "医学部受験塾 Medvance｜現役慶應医学部生による完全1対1個別指導・オンライン",
  },
  description:
    "現役慶應医学部生が完全1対1で指導・伴走する医学部受験塾「Medvance（メドバンス）」。合格から逆算した週次の学習計画、自学自習管理、大学別出願戦略（国公立・私立）、面接・小論文まで。全国オンライン対応。無料の合格戦略診断あり。",
  alternates: {
    canonical: "/",
  },
};
...
const faqs = [
  { q: "どんな生徒が対象ですか？", a: "現役生・浪人生・再受験生すべてに対応しています。学力や年齢を問わず、医学部および「歯学部受験」の合格を目指す方であればどなたでもお申し込みいただけます。" },
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              { label: "歯学部受験を目指す方", desc: "国公立・私立トップ校（東京科学大・東京歯科大・昭和大等）の科目対策と合格ロードマップ", href: "/column/shigakubu-juken" },
            ].map((item) => (
              <Link
                key={item.href}
                href={item.href}
