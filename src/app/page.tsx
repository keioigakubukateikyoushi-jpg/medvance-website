...
const faqs = [
  ...
  { q: "料金はどのくらいかかりますか？", a: "授業は1コマ45分 7,500円（1回の授業90分 = 15,000円）＋コーチング月20,000円のシンプルな構成です。週1回コース（月4回）で月額8万円、週2回コース（月8回）で月額14万円、週3回〜コース（月12回以上）で月額20万円〜（割引あり）となります。入塾金は初回のみ2万円です。" },
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <FadeIn delay={0.1}>
            <div className="grid grid-cols-3 gap-3 mb-6">
              {[
                { label: "月4回", price: "8万円", note: "週1回 ＋ コーチング", highlight: false },
                { label: "月8回", price: "14万円", note: "週2回 ＋ コーチング", highlight: true },
                { label: "月12回", price: "20万円〜", note: "週3回〜 ＋ コーチング（割引あり）", highlight: false },
              ].map((plan, i) => (
                <div
                  key={i}
