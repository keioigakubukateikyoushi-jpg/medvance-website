...
export const metadata = {
  title: "【医学部浪人生の対策】今年で決める合格戦略と再浪人回避の個別指導",
  description:
...
const faqs = [
  {
    q: "鉄緑会や駿台・河合塾などの大手予備校で浪人する場合と、Medvanceの強みの違いは何ですか？",
    a: "鉄緑会などの大手塾では膨大な演習課題による『自学自習の消化不良』で成績が低迷し、再浪人するケースが後を絶ちません。また大手予備校は年間150万〜500万円と超高額です。Medvanceは月額8万円（月4回・8コマ）から受講可能で、現役慶應医学部生による1対1の対話型指導と、15分単位の計画管理により『理解の穴』を完璧に潰し、自学自習の精度を極限まで引き上げるため、低コストで最大の逆転合格率を実現します。",
  },
  {
