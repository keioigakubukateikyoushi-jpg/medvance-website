...
export const metadata = {
  title: "【医学部受験の家庭教師】現役慶應医学部生による完全1対1指導・オンライン対応 | Medvance",
  description:
    "【医学部専門の家庭教師】英語・数学・理科の指導から、面接・小論文・願書添削・毎日のスケジュール管理まで現役慶應医学部生が完全1対1で伴走。オンライン全国対応、関東圏での訪問対面指導も承ります。無料合格戦略診断実施中。",
  keywords: [
    "医学部 家庭教師",
    "医学部受験 家庭教師",
    "医学部専門 家庭教師",
