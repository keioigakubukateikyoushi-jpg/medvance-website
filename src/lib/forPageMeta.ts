...
> = {
  ...
  ronin: {
    ...
    label: "浪人生の方へ",
    faq: [
      { q: "鉄緑会や大手予備校で浪人する場合と、Medvanceの強みの違いは何ですか？", a: "鉄緑会などの集団塾は膨大な課題による『自習の消化不良率』が非常に高く、大手予備校は年間150万〜500万円と超高額です。Medvanceは月額8万円（月4回・8コマ）から受講可能で、15分単位の完全個別学習計画管理と、現役慶應医学部生による1対1指導（1コマ7,500円換算）により、『やりっぱなし』を絶対に防ぎ、大手予備校との併用や単独での逆転合格を徹底サポートします。" },
