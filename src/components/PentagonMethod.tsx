...
const items = [
  ...
  { num: 4, pillar: "DATABASE & AI", label: "独自データベース × AI", body: "学習計画、医学部必須公式データ、オリジナル添削テキストなどの進捗データを生徒専用データベースへ一元集約。さらにAIによる模試分析や理解度トラッキングを組み込み、個別の弱点を完全に可視化・分析します。", Icon: IconDb },
