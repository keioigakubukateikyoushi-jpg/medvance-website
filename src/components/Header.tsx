...
const megaMenus: { label: string; items: DropdownItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "教材見放題の解説", href: "/column/academy-mihoudai", desc: "見放題の内容・使い方・無料お試しの始め方" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "動画・PDF教材が見放題に", href: "/column/academy-mihoudai", desc: "塾生向け教材ライブラリの使い方" },
      { label: "医学部受験のすすめ", href: "/column/igakubu-juken-susume", desc: "医師を目指す価値と始め方" },
      { label: "今から医学部受験を始める人へ", href: "/column/igakubu-genzai-kara", desc: "学年別の最短ルート" },
      { label: "保護者のための医学部受験ガイド", href: "/column/oya-igakubu-juken", desc: "支える側が知っておくべきこと" },
      { label: "動画教材の使い方", href: "/column/video-gakushu-katsuyo", desc: "見放題でも伸びない人の共通点" },
      { label: "医師を目指す理由の作り方", href: "/column/ishi-mezasu-riyuu", desc: "志望理由書・面接の動機" },
